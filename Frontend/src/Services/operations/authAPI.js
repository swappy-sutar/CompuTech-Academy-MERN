  ...
  return async (dispatch) => {
    ...
    try {
      ...
      const errorMessage =
        ...
        "An error occurred while send OTP. Please try again.";
  ...
  return async (dispatch) => {
    ...
    try {
      ...
      const errorMessage =
        error.response?.data?.message ||
        error.message ||
        "An error occurred while send email for resetting password";
      toast.error(errorMessage, { id: toastId });
    } finally {
      dispatch(setLoading(false));
    }
    ...
    try {
      ...
      console.log("RESET PASSWORD TOKEN Error", error);
       const errorMessage =
         error.response?.data?.message ||
         error.message ||
         "An error occurred while Reset password token";
       toast.error(errorMessage);
    }
    dispatch(setLoading(false));
  };
